...
replace github.com/openshift/api => github.com/gnufied/api v0.0.0-20220829190235-c275e8f5194e

replace github.com/openshift/client-go => github.com/gnufied/client-go v0.0.0-20220829223523-1b94f06d8fcf
