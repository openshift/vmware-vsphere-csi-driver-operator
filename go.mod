...
require (
	...
	sigs.k8s.io/vsphere-csi-driver/v3 v3.1.2
)
...
require (
	...
	github.com/vmware-tanzu/vm-operator-api v0.1.4-0.20211202183846-992b48c128ae // indirect
	...
	k8s.io/kubernetes v1.26.8 // indirect
	k8s.io/sample-controller v0.26.8 // indirect
