...
func newVsphereController(apiClients *utils.APIClient) *VSphereController {
	return newVsphereControllerWithGates(apiClients)
}

func newVsphereControllerWithGates(apiClients *utils.APIClient) *VSphereController {
...
func TestApplyClusterCSIDriver(t *testing.T) {
	...
	for i := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			testlib.WaitForSync(commonApiClient, stopCh)
			ctrl := newVsphereControllerWithGates(commonApiClient)
