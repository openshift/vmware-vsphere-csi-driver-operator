...
func NewVSphereConnection(username, password, secretConfigMapHash string, cfg *vsphere.VSphereConfig) *VSphereConnection {
	return &VSphereConnection{
		Username:            username,
		Password:            password,
		SecretConfigMapHash: secretConfigMapHash,
		Config:              cfg,
